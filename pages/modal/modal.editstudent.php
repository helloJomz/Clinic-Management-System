        ...
        <div id="collapseOne" class="accordion-collapse collapse " aria-labelledby="headingOne" data-bs-parent="#accordionExample">
            <div class="accordion-body ">
                ...
                <form action="" method="POST">
                    ...
                    <div class="row mb-3 border-bottom">
                        <div class=" mt-2 mb-2">
                            <h6 class="semi-bold">Change Student Number</h6>
                        </div>
                        <div class="col">
                            <small class="text-muted" >Current Student Number</small><br>
                            <input class="readonly" class="form-control" type="text"  id="edit-sn" placeholder="Student Number" value="<?= $patientRow['studentnumber']; ?>" readonly>
                            <input type="hidden" id="edit-hiddenid-sn" value="<?= $id; ?>">
                        </div>
                        <div class="col">
                            <small class="text-muted" id="l-sn1">New Student Number</small><br>
                            <input type="text" class="form-control" id="edit-new-sn" placeholder="New Student Number" >
                        </div>
                        <div class="col">
                            <small class="text-muted" id="l-sn2">Confirm Student Number</small><br>
                            <input type="text"  class="form-control" id="edit-rpt-sn"  placeholder="Repeat New Student Number">
                        </div>
                        <div class="col mb-5 btnSaveEmail">
                            <button type="button" id="edit-btn-sn" class="btn" style="background-color: #0cbb06 ; color: white; font-size: 12px; padding: 10px 20px;">SAVE</button>
                        </div>
                    </div>
            ...
            <div class="accordion-body">
                ...
                <div class="row mt-4 ">
                    ...
                    <div class="col">
                        ...
                        <input  type="text" class="form-control" id="editphone" placeholder="Phone" value="<?= $patientRow['phone']; ?>" >
                    </div>
                ...
                <div class="row mt-4">
                    <div class="col ">
                        ...
                        <input  type="text" class="form-control" id="editlandline" placeholder="Landline" value="<?= $patientRow['landline']; ?>" >
                    </div>

                    <div class="col">
                        <small class="text-muted">Course</small><br>
                        <select id="editcourse" class="form-control">
                            <option <?php if(isset($patientRow['course']) && $patientRow['course'] == 'DCET'){echo 'selected';}?>>DCET</option>
                            <option <?php if(isset($patientRow['course']) && $patientRow['course'] == 'DEET'){echo 'selected';}?>>DEET</option>
                            <option <?php if(isset($patientRow['course']) && $patientRow['course'] == 'DECET'){echo 'selected';}?>>DECET</option>
                            <option <?php if(isset($patientRow['course']) && $patientRow['course'] == 'DICT'){echo 'selected';}?>>DICT</option>
                            <option <?php if(isset($patientRow['course']) && $patientRow['course'] == 'DOMT'){echo 'selected';}?>>DOMT</option>
                            <option <?php if(isset($patientRow['course']) && $patientRow['course'] == 'DMET'){echo 'selected';}?>>DMET</option>
                            <option <?php if(isset($patientRow['course']) && $patientRow['course'] == 'DRET'){echo 'selected';}?>>DRET</option>
                            <option <?php if(isset($patientRow['course']) && $patientRow['course'] == 'DCVET'){echo 'selected';}?>>DCVET</option>
                        </select>
                    </div>
                    ...
                    <div class="col">
                        ...
                        <select id="edityear" class="form-control">
                            <option <?php if(isset($patientRow['year']) && $patientRow['year'] == '1'){echo 'selected';}?>>1</option>
                            <option <?php if(isset($patientRow['year']) && $patientRow['year'] == '2'){echo 'selected';}?>>2</option>
                            <option <?php if(isset($patientRow['year']) && $patientRow['year'] == '3'){echo 'selected';}?>>3</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="row mt-4">
                    <div class="col">
                        ...
                        <select  id="editsection" class="form-control">
                            <option <?php if(isset($patientRow['section']) && $patientRow['section'] == '1'){echo 'selected';}?>>1</option>
                            <option <?php if(isset($patientRow['section']) && $patientRow['section'] == '2'){echo 'selected';}?>>2</option>
                            <option <?php if(isset($patientRow['section']) && $patientRow['section'] == '3'){echo 'selected';}?>>3</option>
                            <option <?php if(isset($patientRow['section']) && $patientRow['section'] == '4'){echo 'selected';}?>>4</option>
                            <option <?php if(isset($patientRow['section']) && $patientRow['section'] == '5'){echo 'selected';}?>>5</option>
                            <option <?php if(isset($patientRow['section']) && $patientRow['section'] == '6'){echo 'selected';}?>>6</option>
                            <option <?php if(isset($patientRow['section']) && $patientRow['section'] == '7'){echo 'selected';}?>>7</option>
                            <option <?php if(isset($patientRow['section']) && $patientRow['section'] == '8'){echo 'selected';}?>>8</option>
                        </select>
                    </div>
                </div>
