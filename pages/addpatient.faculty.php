...
<div class="container mt-5 bg-white pb-3 pt-4 mb-3 main-container shadow-sm">
    <div class="row border-bottom ps-4 pt-2 pb-2 pe-4 bg-white ">
        <div class="">
            <h4>Create Patient <i class="fas fa-chevron-right font-blue ms-1"></i> Faculty</h4>
            ...
            <div class="row mt-4">  
                ...
                <div class="col-sm-3">
                    ...
                    <select name="department" class="w-100">
                        ...
                        <option <?php if(isset($_SESSION['department']) && $_SESSION['department'] == 'Computer Management'){echo 'selected';}?>>Computer Management</option>
                        <option <?php if(isset($_SESSION['department']) && $_SESSION['department'] == 'Engineering Technology'){echo 'selected';}?>>Engineering Technology</option>
                    </select>
                </div>
