...
<div class="container mt-5 bg-white pb-3 pt-4 mb-3 main-container shadow-sm">
    <div class="row border-bottom ps-4 pt-2 pb-2 pe-4 bg-white ">
        <div class="">
            <h4>Create Patient <i class="fas fa-chevron-right font-blue ms-1"></i> Itech Personnel</h4>
            <p class="text-muted minor-text p-0">All informations below are important, please fill all the fields.</p>
        </div>
    </div>
    
    <form action="../includes/addpatient.merge.inc.php" method="POST" id="formsubmit" enctype="multipart/form-data" >
        <input type="hidden" name="realmode" value="<?= $mode ?>">
        ...
        <div class="container-fluid">
            ...
            <div class="row mt-4">  
                ...
                <div class="col-sm-3">
                    ...
                    <input type="date" name="birthday" class="w-100" value="<?php if(isset($_SESSION['birthday'])){echo $_SESSION['birthday'];}?>">
                </div>

                <div class="col-sm-3">
                    <small class="text-muted">Department</small><br>
                    <select name="department" class="w-100">
                        <option selected>Department</option>
                        <option <?php if(isset($_SESSION['department']) && $_SESSION['department'] == 'Staff'){echo 'selected';}?>>Staff</option>
                        <option <?php if(isset($_SESSION['department']) && $_SESSION['department'] == 'Maintenance Personnel'){echo 'selected';}?>>Maintenance Personnel</option>
                        <option <?php if(isset($_SESSION['department']) && $_SESSION['department'] == 'Security Personnel'){echo 'selected';}?>>Security Personnel</option>
                    </select>
                </div>
           ...
           <div class="row ">
            ...
            <div class="mt-4 text-end">
                <a href="search.php?search" class="btn btn-secondary me-2">Cancel</a>
                <button class="btn create" name="<?php echo 'create'.$mode; ?>" type="submit">Create</button>
                </form>
            </div>
