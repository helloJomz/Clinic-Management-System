...
<?php 
    ...
    $countRequestSql = "SELECT id FROM request_log WHERE studentid=$id ";
    $countRequestResult = mysqli_query($conn, $countRequestSql);
    $countRequestRow = mysqli_num_rows($countRequestResult);

    $countQueueSql = "SELECT id FROM queue_log WHERE studentid=$id ";
...
<div class="container mt-4 ps-5 pe-5">
    ...
    <div class="d-flex">
        <div class="mt-2 me-5">
            ...
            <span class="semi-bold me-2"> Student</span>
            <span class="badge bg-secondary course-badge ms-1"><?php echo $patientRow['course']." ".$patientRow['year']."-".$patientRow['section'];?></span>
        </div>

        <div class="ms-5">
            <!-- <button class="shadow-sm bg-white me-3 color-gray rounded p-2 edit-patient fs-6">
                <i class="fas fa-file-prescription me-2"></i>Prescribe
            </button> -->
...
<div class="container mt-2 ps-5 pe-5">
    <div class="row ">
        <div class="col-md-3 me-3 mb-2 bg-white shadow-sm p-3 rounded ">
            ...
            <div class="d-flex justify-content-center text-center">
                <p class="p-0 small-text color-gray" id="edit-sn1"><?= $patientRow['studentnumber'];?></p>
            </div>
            ...
            <div class="text-center moveCountVisit">
                <div class="col p-0 w-0">
                    <button type="button" id="requestModalStudent" class="btn bg-none title-card-color adjust-modal-a-left" data-bs-toggle="modal" data-bs-target="#request-modal">
                        <h4><?php echo $countRequestRow + $countQueueRow; ?></h4>
                    </button>
                </div>
            </div>
        ...
        <div class="col-md-5 me-3 mb-2 bg-white shadow-sm  rounded ">
        ...
        <div class="col-md-3 mb-2 me-2 bg-white shadow-sm rounded ">
            <div class="container d-flex justify-content-between p-2 ">
            ...
            <div class="ms-2 mt-4 overflow-auto">
               <div class="row">
                    <div class="col">
...
<div class="container mt-1 pb-5 ps-5 pe-5">
    <div class="row">
        ...
        <div class="col-md-3 mb-2 bg-white shadow-sm rounded me-3 card5">
            ...
            <button class="btn-primary btn mt-2 float-end py-1 rounded" style="z-index: 2000;" type="button" id="addnote" data-bs-target="#addnotebtn" aria-expanded="false" aria-controls="collapseExample">Add Note</button>
        </div>
        ...
        <div class="col-md-3 mb-2 bg-white shadow-sm rounded card6">
            ...
            <div class="row d-flex justify-content-center">
                <?php 
                    $sql = "SELECT * FROM files WHERE studentid = $id "; 
                    $result = mysqli_query($conn, $sql);
                    if(mysqli_num_rows($result) > 0 ) {
                    while($fileRow = mysqli_fetch_array($result)) :
                    $fileName = str_replace("../assets/uploads/patient_files/", "",$fileRow['filepath']);
                    $studentnumber = $patientRow['studentnumber'];
                    $finalFileName = str_replace("$studentnumber", "", $fileName);
                ?>
                <div>
        ...
        <!--- STUDENT ID-->
        <input type="hidden" id="hiddenstudentid" value="<?php echo $id; ?>">
    ...
    <div class="modal-content ">
      ...
      <div class="modal-body">
            <div class="container only-modal-edit">
                <?php include 'modal/modal.editstudent.php'; ?>
            </div>
      </div>
            ...
            <div class="mt-4 content-note">
                <div class="container">
                    ...
                    <div class="text-end mt-3">
                            ...
                            <input type="hidden" id="note_mode" value="student">
                    </div>
                </div>
            </div>
      </div>
    ...
    <div class="modal-content">
      <div class="modal-body">
        <div>
            ...
            <input type="hidden" class="patternid">
...
<!--- MODAL FOR VISIT -->
<div class="modal fade pb-5" id="request-modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-body">
          ...
          <h5 class="mt-4"><strong>Request</strong></h5>
...
<script src="../assets/js/updatepatient1.js?<?php echo time();?>"></script>
<script src="../assets/js/updatepatient.js?<?php echo time();?>"></script>
