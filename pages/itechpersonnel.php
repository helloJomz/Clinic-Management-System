...
<?php $title = "Itech Personnel's Profile";?>
...
<?php 
    ...
    $countRequestSql = "SELECT id FROM request_log WHERE itechpersonnelid=$id ";
    $countRequestResult = mysqli_query($conn, $countRequestSql);
    $countRequestRow = mysqli_num_rows($countRequestResult);

    $countQueueSql = "SELECT id FROM queue_log WHERE itechpersonnelid=$id ";
...
<div class="container mt-4 ps-5 pe-5">
    <div class="d-flex">
        <div class="mt-2 me-3">
            ...
            <span class="semi-bold me-2"> Personnel </span>
            <span class="badge bg-secondary course-badge"><?php if($patientRow['department'] == 'Staff'){echo $patientRow['department']." Personnel";}else{echo $patientRow['department'];} ?></span>
        </div>

        
        <div class="<?php if($patientRow['department'] == 'Staff'){echo 'ms-4';}elseif($patientRow['department'] == 'Security Personnel'){echo 'ms-4';}?>">
        ...
        <div class="col-md-3 mb-2 bg-white shadow-sm me-3 p-3 rounded">
            ...
            <div class="text-center moveCountVisit">
                <div class="col p-0 w-0">
                    <button type="button" id="requestModalItechpersonnel" class="btn bg-none title-card-color adjust-modal-a-left" data-bs-toggle="modal" data-bs-target="#visit-modal">
...
<div class="container pb-5 ps-5 pe-5">
    <div class="row">
        ...
        <div class="col-md-3 mb-2 bg-white shadow-sm rounded card6">
            ...
            <div class="row d-flex justify-content-center">
                <?php 
                    $sql = "SELECT * FROM files WHERE itechpersonnelid = $id "; 
    ...
    <!--- FACULTY ID-->
    <input type="hidden" id="hiddenitechpersonnelid" value="<?php echo $id; ?>">
    ...
    <div class="modal-content ">
      ...
      <div class="modal-body">
            <div class="container only-modal-edit">
                <?php include 'modal/modal.edititechpersonnel.php'; ?>
            </div>
      </div>
            ...
            <div class="mt-4 content-note">
                <div class="container">
                    ...
                    <div class="text-end mt-3">
                            ...
                            <input type="hidden" id="note_mode" value="itechpersonnel">
                    </div>
                </div>
            </div>
      </div>
