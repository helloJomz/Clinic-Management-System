...
<head>
    ...
    <title>Admin Login | WEBNIC</title>
...
<div class="alert alert-warning text-center m-0" role="alert">
  Good Day! For Admin Account, please use this account to login: for email use <strong>admin@gmail.com</strong> and for password use <strong>admin</strong> both email and password are all in lowercase.
</div>
...
<div class="container main-container mb-5 pb-4 ps-2 pe-2">
    ...
    <div class="main-card w-100 rounded shadow-sm p-4 mt-5 mx-auto">
        ...
        <div class="form-group">
            ...
            <input type="text" id="labelEmail" class="form-control" placeholder="Enter Email" name="username"> 
        </div>

        <div class="form-group mt-3">
            <label for="labelPassword" class="form-label text-muted">Password</label>
            <input type="password" id="labelPassword" class="form-control" placeholder="Enter Password" name="pwd"> 
        </div>
